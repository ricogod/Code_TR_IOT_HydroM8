...
class HumidityWidget extends StatelessWidget {  //ganti TemperatureWidget
   HumidityWidget({Key? key, required this.humidity}) : super(key: key);
  final int humidity;  //ganti
  final streamChart = FirebaseFirestore.instance
      .collection('humidity') //ganti
            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  List<HumData> HumDataList = snapshot.data!.docs.map((e) {  //ganti
                    return HumData(
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  // Take the first 5 data points with the greatest 'timevalue'
                  List<HumData> topFiveData = HumDataList.take(5).toList();  //ganti
