...
class TemperatureWidget extends StatelessWidget {  //ganti TemperatureWidget
   TemperatureWidget({Key? key, required this.temperature}) : super(key: key);
  final int temperature;  //ganti
  final streamChart = FirebaseFirestore.instance
      .collection('temperature') //ganti
            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  List<TempData> TempDataList = snapshot.data!.docs.map((e) {  //ganti
                    return TempData(
                  ...
                  TempDataList.sort((a, b) => b.domain.compareTo(a.domain));  //ganti
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  // Take the first 5 data points with the greatest 'timevalue'
                  List<TempData> topFiveData = TempDataList.take(5).toList();  //ganti
