  ...
  String displayDay='Every';
   ...
   void updateDisplayDay() {
    if (sunday && monday && tuesday && wednesday && thursday && friday && saturday) {
      setState(() {
        displayDay = 'Every day';
      });
    } else if (!sunday && !monday && !tuesday && !wednesday && !thursday && !friday && !saturday) {
      setState(() {
        displayDay = 'No day selected';
      });
    } else {
      setState(() {
        displayDay = 'Every';
        displayDay += sunday ? ' Sun' : '';
        displayDay += monday ? ' Mon' : '';
        displayDay += tuesday ? ' Tue' : '';
        displayDay += wednesday ? ' Wed' : '';
        displayDay += thursday ? ' Thu' : '';
        displayDay += friday ? ' Fri' : '';
        displayDay += saturday ? ' Sat' : '';
      });
    }
  }
  @override
