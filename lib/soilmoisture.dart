...
class SoilData{   //ganti
  final double domain;
  final double measure;
  final String sideTitles;
...
class SoilmoistureWidget extends StatelessWidget {  //ganti TemperatureWidget
   SoilmoistureWidget({Key? key, required this.soil}) : super(key: key);
  final int soil;  //ganti
  final streamChart = FirebaseFirestore.instance
      .collection('soilmoisture') //ganti
            ...
            children: [
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  List<SoilData> SoilDataList = snapshot.data!.docs.map((e) {  //ganti
                    return SoilData(
                      domain: e.data()['timevalue'].toDouble(),
                      measure: e.data()['moist'].toDouble(), //ganti
                      sideTitles:  e.data()['hourvalue'].toString(),
                    );
                  }).toList();

                  // Sort the list in descending order based on the 'domain' (timevalue)

                  SoilDataList.sort((a, b) => b.domain.compareTo(a.domain));  //ganti
                        ...
                        LineChartData(
                          lineTouchData: LineTouchData(
                            ...
                            touchTooltipData: LineTouchTooltipData(
                              tooltipBgColor: Color(0xFFEAE3E3),
                            ),
                          ),
              ...
              StreamBuilder(
                ...
                builder: (context,
                  ...
                  // Take the first 5 data points with the greatest 'timevalue'
                  List<SoilData> topFiveData = SoilDataList.take(5).toList();  //ganti
